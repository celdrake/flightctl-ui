...
TEST_OIDC_PROVIDER_CLIENT_ID=${TEST_OIDC_PROVIDER_CLIENT_ID}
TEST_OIDC_PROVIDER_CLIENT_SECRET=${TEST_OIDC_PROVIDER_CLIENT_SECRET}
TEST_OAUTH2_PROVIDER_CLIENT_ID=${TEST_OAUTH2_PROVIDER_CLIENT_ID}
TEST_OAUTH2_PROVIDER_CLIENT_SECRET=${TEST_OAUTH2_PROVIDER_CLIENT_SECRET}
...
export TEST_OIDC_PROVIDER_CLIENT_ID=$TEST_OIDC_PROVIDER_CLIENT_ID
export TEST_OIDC_PROVIDER_CLIENT_SECRET=$TEST_OIDC_PROVIDER_CLIENT_SECRET
export TEST_OAUTH2_PROVIDER_CLIENT_ID=$TEST_OAUTH2_PROVIDER_CLIENT_ID
export TEST_OAUTH2_PROVIDER_CLIENT_SECRET=$TEST_OAUTH2_PROVIDER_CLIENT_SECRET
...
echo "  GOOGLE_PROVIDER_CLIENT_ID=${TEST_OIDC_PROVIDER_CLIENT_ID:-'(unset)'}" >&2
echo "  GOOGLE_PROVIDER_CLIENT_SECRET=$(mask_secret "$TEST_OIDC_PROVIDER_CLIENT_SECRET")" >&2
echo "  GITHUB_PROVIDER_CLIENT_ID=${TEST_OAUTH2_PROVIDER_CLIENT_ID:-'(unset)'}" >&2
echo "  GITHUB_PROVIDER_CLIENT_SECRET=$(mask_secret "$TEST_OAUTH2_PROVIDER_CLIENT_SECRET")" >&2
echo >&2
