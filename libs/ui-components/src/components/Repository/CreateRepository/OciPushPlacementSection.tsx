    ...
    <FormGroupWithHelperText
      ...
      content={
        <>
          <p>
            {t(
              'Defines how image paths are organized when this registry stores content. Applies to image builds and delta artifacts.',
            )}
          </p>
      ...
      <Stack hasGutter>
        ...
        <StackItem>
          <RadioField
            ...
            description={t('All images are stored at the same fixed path.')}
