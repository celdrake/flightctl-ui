...
type SecurityOverviewSummaryOverviewProps = {
  variant?: 'overview';
};

type SecurityOverviewSummaryEntityDetailProps = {
...
type SecurityOverviewSummaryProps = SecurityOverviewSummaryOverviewProps | SecurityOverviewSummaryEntityDetailProps;

const SecurityOverviewSummaryOverview = () => {
  const { t } = useTranslation();
...
const SecurityOverviewSummary = (props: SecurityOverviewSummaryProps) => {
  if (props.variant === 'entityDetail') {
    const { counts, selectedSeverity = null, onSeverityToggle, isLoading = false } = props;
    return (
      <SeverityTilesGrid
        counts={counts}
        interactive
  ...
  return <SecurityOverviewSummaryOverview />;
};
