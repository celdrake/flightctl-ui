...
export type PrepareDeltasDetails = {
  ...
  specHash?: string;
  /**
   * The resource version of the involved Fleet or Device when this prepare event was created. Used to ignore stale prepare events. Required for PrepareDeltas events.
   */
